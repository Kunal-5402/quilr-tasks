...
from fde.core.errors import InvalidRequest, install_handlers, new_request_id
from fde.core.logging import get_logger
from fde.task4_router.limiter import TokenRateLimiter, estimate_tokens
from fde.task4_router.providers import Provider
...
async def completions(
    ...
    return JSONResponse(
        ...
        headers={"X-FDE-Provider": result.provider},
    )
