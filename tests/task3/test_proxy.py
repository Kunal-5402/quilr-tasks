...
from fde.task3_stream_guardrail.sse import SseParser
...
async def test_the_first_token_arrives_before_the_provider_finishes():
    ...
    from fde.task3_stream_guardrail import mock_provider, proxy
...
async def test_a_provider_failure_becomes_an_error_event(gateway, monkeypatch):
    from fde.task3_stream_guardrail import proxy
